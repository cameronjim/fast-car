...
def test_accepts_when_contract_matches_the_real_committed_params(
    ...
    # config/vehicle_params.yaml currently has meta.schema_version = "0.4.0" (0.1.0 ->
    ...
    # two required actuation fields, GitHub issue #66, see that file's header) and
    # meta.sysid_session_id =
